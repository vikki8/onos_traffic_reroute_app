...
public final class OsgiPropertyConstants {
    ...
    static final int LIMIT_DEFAULT = 15;

    static final String INTENT = "intent";
    static final boolean INTENT_DEFAULT = false;

    static final String FORWARDING = "forwarding";
    static final int FORWARDING_DEFAULT = 1;

    static final String CAMPUS = "campus";
    static final boolean CAMPUS_DEFAULT = true;
